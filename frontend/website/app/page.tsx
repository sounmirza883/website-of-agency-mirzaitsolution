    ...
    <section className="campaign-hero">
      ...
      <div className="container">
        <FadeIn direction="none">
          ...
          <div className="campaign-actions"><Link href="/portfolio" className="pill pill-primary magnetic-btn"><Icon name="fa-eye" /> View Our Work</Link><Link href="/contact" className="pill pill-outline magnetic-btn"><Icon name="fa-arrow-right" /> Start Your Project</Link></div>
          ...
          <div className="hero-stats"><div className="hero-stat"><div className="hero-stat-number">100+</div><div className="hero-stat-label">Projects Completed</div></div><div className="hero-stat"><div className="hero-stat-number">50+</div><div className="hero-stat-label">Happy Clients</div></div><div className="hero-stat"><div className="hero-stat-number">24/7</div><div className="hero-stat-label">Client Support</div></div></div>
        </FadeIn>
      </div>
    </section>
