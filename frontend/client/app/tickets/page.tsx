  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-1">
        <h1 className="text-2xl font-bold" style={{color:"var(--ink)"}}>Support Tickets</h1>
        <div style={{display:"flex",gap:"4px",background:"var(--soft)",borderRadius:"12px",padding:"4px"}}>
