...
type Project = { id: number; name: string; status: string; deadline: string; progress: number };
type Milestone = { id: number; project: string; task: string; status: string; date: string };
type File = { id: number; name: string; project: string; size: string; uploaded: string };
type Invoice = { id: string; project: string; amount: string; status: string; due: string };
type Ticket = { id: string; subject: string; status: string; priority: string; updated: string };
