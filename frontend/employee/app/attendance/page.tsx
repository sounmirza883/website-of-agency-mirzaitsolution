      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="text-right">
          <div className="flex gap-2">
            <button onClick={handleCheckIn} disabled={!canCheckIn || checkIn.isPending} className="bg-accent-2 text-white text-sm font-medium px-4 py-2 rounded-lg disabled:opacity-50">{checkIn.isPending ? "Checking In…" : "Check In"}</button>
