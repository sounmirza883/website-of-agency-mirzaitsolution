...
import { useUsers, useSetUserStatus } from "../hooks";
            ...
            <tr key={u.id} className="border-t border-gray-100 hover:bg-gray-50">
              ...
              <td className="px-5 py-3">
                <button
                  ...
                  className={`text-xs font-medium px-2 py-0.5 rounded ${u.status === "Active" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-600"}`}
                >
                  {u.status}
                </button>
              </td>
