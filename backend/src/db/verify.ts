...
const TABLES: Record<string, string[]> = {
  ...
  chat_conversations: ["kind", "last_message_at"],
  chat_members: ["conversation_id", "user_id", "last_read_message_id"],
  chat_messages: ["conversation_id", "sender_id", "created_at"],
  project_files: ["path", "uploaded_by", "client_id"],
  employee_tasks: ["employee_id", "project_id", "assigned_by", "scheduled_start", "progress"],
  work_settings: ["work_days", "start_time", "end_time"],
  employee_schedules: ["employee_id"],
  task_time_entries: ["task_id", "started_at", "ended_at"],
  task_reports: ["task_id", "summary"],
  daily_reports: ["employee_id", "work_date", "summary"],
  project_message_reads: ["project_id", "user_id", "last_read_message_id"],
  employee_attendance: ["check_in", "check_out", "work_date", "checked_in_at"],
